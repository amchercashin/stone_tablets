function add_record() {
    if (Number(2048 - (new Blob([document.getElementById("record_to_add").value])).size) >= 0) {
        ...
        tablet_instance.add_record(document.getElementById("record_to_add").value, {from:web3.eth.accounts[0], to:tablet_factory, value:"", gas:850000, gasPrice:"4000000000"},
